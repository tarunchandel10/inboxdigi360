                        ...
                        <form className="create-form-box" onSubmit={handleSubmit}>
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <FormField icon={<PersonFill />} className={`${errors.domain_name ? 'form-error' : ''}`} type="text" name="domain_name" placeholder="Domain Name" value={formValues.domain_name} required onChange={handleInputChange} />
                                </div>
                                <div className="col-md-6">
