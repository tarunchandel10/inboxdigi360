...
export default function YouTubeVideoCreativeForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isValid) {
            ...
            const payload = {
                ...
                creative_upload_type: 'youtube_video',
                append_tracking,
                tags,
                landing_page_url,
                video_skip_button,
            ...
            <div className={`${FormCss.top_bar}`}>
                <div className={`${FormCss.container} container`}>
                    <div className={`${FormCss.form_title}`}>
                        ...
                        <h4>New YouTube Video Creative</h4>
                    </div>
                </div>
            </div>
                                ...
                                <div className={`${FormCss.row}`}>
                                    <div className="col-md-6">
                                        ...
                                        <div className={`${FormCss.form_feilds}`}>
                                            ...
                                            <input type="url" id="youtubeURL" name="youtubeURL" placeholder="YouTube URL" value={youtube_url} onChange={(e) => setYoutubeURL(e.target.value)} />
                                        </div>
                                ...
                                <div className={`${FormCss.row}`}>
                                    <div className="col-md-12">
                                        ...
                                        {video_skip_button === '1' && (
                                            <>
                                                <div className={`${FormCss.form_feilds}`}>
                                                    <label htmlFor="offset">Skip Offset</label>
